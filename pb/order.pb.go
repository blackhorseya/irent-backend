...
type OrderInfo struct {
	...
	StopPickAt   int64   `protobuf:"varint,7,opt,name=stop_pick_at,json=stopPickAt,proto3" json:"stop_pick_at,omitempty"`
}
...
func (x *OrderInfo) GetEndAt() int64 {
	if x != nil {
		return x.EndAt
	}
	return 0
...
func (x *OrderInfo) GetStopPickAt() int64 {
	if x != nil {
		return x.StopPickAt
	}
	return 0
...
var file_pb_order_proto_rawDesc = []byte{
	...
	0x5f, 0x61, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x73, 0x74, 0x6f, 0x70, 0x50,
