...
func CreateApp(path2 string) (*app.Application, error) {
	...
	runnerOptions, err := runner.NewOptions(viper)
	if err != nil {
		return nil, err
	}
	runnerRunner, err := runner.NewEngine(runnerOptions, logger)
	if err != nil {
		return nil, err
	}
...
var providerSet = wire.NewSet(log.ProviderSet, config.ProviderSet, http.ProviderSet, runner.ProviderSet, irent.ProviderSet, apis.ProviderSet, biz.ProviderSet)
