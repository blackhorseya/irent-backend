...
var providerSet = wire.NewSet(config.ProviderSet, log.ProviderSet, restclient.ProviderSet, http.ProviderSet, irent.ProviderSet, restful.ProviderSet, biz.ProviderSet)
